...
export const databaseWorkerExtensionTestFiles = [
  ...
  "extensions/line/doctor-contract-api.test.ts",
  "extensions/line/src/monitor.lifecycle.test.ts",
  "extensions/line/src/webhook-spool-migration.test.ts",
  "extensions/line/src/webhook-spool.image-set.test.ts",
  "extensions/line/src/webhook-spool.test.ts",
  "extensions/mattermost/src/mattermost/monitor-ingress.test.ts",
  ...
  "extensions/sms/src/ingress-spool.test.ts",
  "extensions/synology-chat/src/webhook-ingress.test.ts",
  ...
  "extensions/whatsapp/src/monitor-inbox.append.test.ts",
  "extensions/whatsapp/src/monitor-inbox.debounce-policy.test.ts",
  "extensions/whatsapp/src/monitor-inbox.delivery-and-dedupe.test.ts",
  "extensions/whatsapp/src/monitor-inbox.media-and-session.test.ts",
  "extensions/whatsapp/src/monitor-inbox.metadata-cache.test.ts",
